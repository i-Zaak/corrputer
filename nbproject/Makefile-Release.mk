...
${OBJECTDIR}/SimpleComputationFramework.o: SimpleComputationFramework.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/SimpleComputationFramework.o SimpleComputationFramework.cpp

${OBJECTDIR}/ValueStream.o: ValueStream.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/ValueStream.o ValueStream.cpp

${OBJECTDIR}/ScopeWinInput.o: ScopeWinInput.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/ScopeWinInput.o ScopeWinInput.cpp

${OBJECTDIR}/CrossCorrelationComputer.o: CrossCorrelationComputer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/CrossCorrelationComputer.o CrossCorrelationComputer.cpp

${OBJECTDIR}/NiftiInput.o: NiftiInput.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/NiftiInput.o NiftiInput.cpp

${OBJECTDIR}/main.o: main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/main.o main.cpp

${OBJECTDIR}/DataInputIface.o: DataInputIface.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/DataInputIface.o DataInputIface.cpp

${OBJECTDIR}/SourceInfo.o: SourceInfo.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/SourceInfo.o SourceInfo.cpp

${OBJECTDIR}/ComputationFramework.o: ComputationFramework.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/ComputationFramework.o ComputationFramework.cpp

${OBJECTDIR}/main_mpi.o: main_mpi.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/main_mpi.o main_mpi.cpp

${OBJECTDIR}/mpi/Saver.o: mpi/Saver.cpp 
	${MKDIR} -p ${OBJECTDIR}/mpi
	${RM} $@.d
	$(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/mpi/Saver.o mpi/Saver.cpp

${OBJECTDIR}/CorrelationComputer.o: CorrelationComputer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/CorrelationComputer.o CorrelationComputer.cpp

${OBJECTDIR}/WindowedStatisticsComputer.o: WindowedStatisticsComputer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/WindowedStatisticsComputer.o WindowedStatisticsComputer.cpp

${OBJECTDIR}/DistributedComputationFramework.o: DistributedComputationFramework.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/DistributedComputationFramework.o DistributedComputationFramework.cpp

${OBJECTDIR}/FrameContainerGenerator.o: FrameContainerGenerator.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/FrameContainerGenerator.o FrameContainerGenerator.cpp

${OBJECTDIR}/mpi/common.o: mpi/common.cpp 
	${MKDIR} -p ${OBJECTDIR}/mpi
	${RM} $@.d
	$(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/mpi/common.o mpi/common.cpp
...
${OBJECTDIR}/mpi/Worker.o: mpi/Worker.cpp 
	${MKDIR} -p ${OBJECTDIR}/mpi
	${RM} $@.d
	$(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/mpi/Worker.o mpi/Worker.cpp

${OBJECTDIR}/lib/swutils.o: lib/swutils.C 
	${MKDIR} -p ${OBJECTDIR}/lib
	${RM} $@.d
	$(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/lib/swutils.o lib/swutils.C

${OBJECTDIR}/ConfigFile.o: ConfigFile.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/ConfigFile.o ConfigFile.cpp

${OBJECTDIR}/ValueContainer.o: ValueContainer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/ValueContainer.o ValueContainer.cpp

${OBJECTDIR}/mpi/Coordinator.o: mpi/Coordinator.cpp 
	${MKDIR} -p ${OBJECTDIR}/mpi
	${RM} $@.d
	$(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/mpi/Coordinator.o mpi/Coordinator.cpp

${OBJECTDIR}/SourcePointInfo.o: SourcePointInfo.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/SourcePointInfo.o SourcePointInfo.cpp
...
${TESTDIR}/TestFiles/f6: ${TESTDIR}/tests/FFTtest.o ${OBJECTFILES:%.o=%_nomain.o}
...
${TESTDIR}/tests/ConfigFileTest.o: tests/ConfigFileTest.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -MMD -MP -MF $@.d -o ${TESTDIR}/tests/ConfigFileTest.o tests/ConfigFileTest.cpp


${TESTDIR}/tests/CrossCorrelationTest.o: tests/CrossCorrelationTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -MMD -MP -MF $@.d -o ${TESTDIR}/tests/CrossCorrelationTest.o tests/CrossCorrelationTest.cpp


${TESTDIR}/tests/CrossCorrelationTestRunner.o: tests/CrossCorrelationTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -MMD -MP -MF $@.d -o ${TESTDIR}/tests/CrossCorrelationTestRunner.o tests/CrossCorrelationTestRunner.cpp


${TESTDIR}/tests/DistributedComputationFrameworkTest.o: tests/DistributedComputationFrameworkTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -MMD -MP -MF $@.d -o ${TESTDIR}/tests/DistributedComputationFrameworkTest.o tests/DistributedComputationFrameworkTest.cpp


${TESTDIR}/tests/DistributedComputationFrameworkTestRunner.o: tests/DistributedComputationFrameworkTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -MMD -MP -MF $@.d -o ${TESTDIR}/tests/DistributedComputationFrameworkTestRunner.o tests/DistributedComputationFrameworkTestRunner.cpp


${TESTDIR}/tests/TestedDistributedComputationFramework.o: tests/TestedDistributedComputationFramework.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -MMD -MP -MF $@.d -o ${TESTDIR}/tests/TestedDistributedComputationFramework.o tests/TestedDistributedComputationFramework.cpp
...
${TESTDIR}/tests/RunningVarianceTest.o: tests/RunningVarianceTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -MMD -MP -MF $@.d -o ${TESTDIR}/tests/RunningVarianceTest.o tests/RunningVarianceTest.cpp


${TESTDIR}/tests/ValueContainerSerializationTest.o: tests/ValueContainerSerializationTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -MMD -MP -MF $@.d -o ${TESTDIR}/tests/ValueContainerSerializationTest.o tests/ValueContainerSerializationTest.cpp


${TESTDIR}/tests/testrunner.o: tests/testrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -MMD -MP -MF $@.d -o ${TESTDIR}/tests/testrunner.o tests/testrunner.cpp
...
${OBJECTDIR}/SimpleComputationFramework_nomain.o: ${OBJECTDIR}/SimpleComputationFramework.o SimpleComputationFramework.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/SimpleComputationFramework_nomain.o SimpleComputationFramework.cpp;\
	else  \
...
${OBJECTDIR}/ValueStream_nomain.o: ${OBJECTDIR}/ValueStream.o ValueStream.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/ValueStream_nomain.o ValueStream.cpp;\
	else  \
...
${OBJECTDIR}/ScopeWinInput_nomain.o: ${OBJECTDIR}/ScopeWinInput.o ScopeWinInput.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/ScopeWinInput_nomain.o ScopeWinInput.cpp;\
	else  \
...
${OBJECTDIR}/CrossCorrelationComputer_nomain.o: ${OBJECTDIR}/CrossCorrelationComputer.o CrossCorrelationComputer.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/CrossCorrelationComputer_nomain.o CrossCorrelationComputer.cpp;\
	else  \
...
${OBJECTDIR}/NiftiInput_nomain.o: ${OBJECTDIR}/NiftiInput.o NiftiInput.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/NiftiInput_nomain.o NiftiInput.cpp;\
	else  \
...
${OBJECTDIR}/main_nomain.o: ${OBJECTDIR}/main.o main.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/main_nomain.o main.cpp;\
	else  \
...
${OBJECTDIR}/DataInputIface_nomain.o: ${OBJECTDIR}/DataInputIface.o DataInputIface.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/DataInputIface_nomain.o DataInputIface.cpp;\
	else  \
...
${OBJECTDIR}/SourceInfo_nomain.o: ${OBJECTDIR}/SourceInfo.o SourceInfo.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/SourceInfo_nomain.o SourceInfo.cpp;\
	else  \
...
${OBJECTDIR}/ComputationFramework_nomain.o: ${OBJECTDIR}/ComputationFramework.o ComputationFramework.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/ComputationFramework_nomain.o ComputationFramework.cpp;\
	else  \
...
${OBJECTDIR}/main_mpi_nomain.o: ${OBJECTDIR}/main_mpi.o main_mpi.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/main_mpi_nomain.o main_mpi.cpp;\
	else  \
...
${OBJECTDIR}/mpi/Saver_nomain.o: ${OBJECTDIR}/mpi/Saver.o mpi/Saver.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/mpi/Saver_nomain.o mpi/Saver.cpp;\
	else  \
...
${OBJECTDIR}/CorrelationComputer_nomain.o: ${OBJECTDIR}/CorrelationComputer.o CorrelationComputer.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/CorrelationComputer_nomain.o CorrelationComputer.cpp;\
	else  \
...
${OBJECTDIR}/WindowedStatisticsComputer_nomain.o: ${OBJECTDIR}/WindowedStatisticsComputer.o WindowedStatisticsComputer.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/WindowedStatisticsComputer_nomain.o WindowedStatisticsComputer.cpp;\
	else  \
...
${OBJECTDIR}/DistributedComputationFramework_nomain.o: ${OBJECTDIR}/DistributedComputationFramework.o DistributedComputationFramework.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/DistributedComputationFramework_nomain.o DistributedComputationFramework.cpp;\
	else  \
...
${OBJECTDIR}/FrameContainerGenerator_nomain.o: ${OBJECTDIR}/FrameContainerGenerator.o FrameContainerGenerator.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/FrameContainerGenerator_nomain.o FrameContainerGenerator.cpp;\
	else  \
...
${OBJECTDIR}/mpi/common_nomain.o: ${OBJECTDIR}/mpi/common.o mpi/common.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/mpi/common_nomain.o mpi/common.cpp;\
	else  \
...
${OBJECTDIR}/ValueFrame_nomain.o: ${OBJECTDIR}/ValueFrame.o ValueFrame.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/ValueFrame_nomain.o ValueFrame.cpp;\
	else  \
...
${OBJECTDIR}/mpi/Worker_nomain.o: ${OBJECTDIR}/mpi/Worker.o mpi/Worker.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/mpi/Worker_nomain.o mpi/Worker.cpp;\
	else  \
...
${OBJECTDIR}/lib/swutils_nomain.o: ${OBJECTDIR}/lib/swutils.o lib/swutils.C 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/lib/swutils_nomain.o lib/swutils.C;\
	else  \
...
${OBJECTDIR}/ConfigFile_nomain.o: ${OBJECTDIR}/ConfigFile.o ConfigFile.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/ConfigFile_nomain.o ConfigFile.cpp;\
	else  \
...
${OBJECTDIR}/ValueContainer_nomain.o: ${OBJECTDIR}/ValueContainer.o ValueContainer.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/ValueContainer_nomain.o ValueContainer.cpp;\
	else  \
...
${OBJECTDIR}/mpi/Coordinator_nomain.o: ${OBJECTDIR}/mpi/Coordinator.o mpi/Coordinator.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/mpi/Coordinator_nomain.o mpi/Coordinator.cpp;\
	else  \
...
${OBJECTDIR}/SourcePointInfo_nomain.o: ${OBJECTDIR}/SourcePointInfo.o SourcePointInfo.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O3 -DMAIN_CORRELATOR_MPI `pkg-config --cflags fftw3`    -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/SourcePointInfo_nomain.o SourcePointInfo.cpp;\
	else  \
