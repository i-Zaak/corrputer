...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/masterserver_debug: ${OBJECTFILES}
	...
	mpic++ -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/masterserver_debug ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
${OBJECTDIR}/WindowedStatisticsComputer.o: WindowedStatisticsComputer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -DMAIN_CORRELATOR_MPI -I/usr/include/mpi -I/usr/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/WindowedStatisticsComputer.o WindowedStatisticsComputer.cpp
...
${OBJECTDIR}/FrameContainerGenerator.o: FrameContainerGenerator.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -DMAIN_CORRELATOR_MPI -I/usr/include/mpi -I/usr/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/FrameContainerGenerator.o FrameContainerGenerator.cpp
...
${OBJECTDIR}/ConfigFile.o: ConfigFile.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -DMAIN_CORRELATOR_MPI -I/usr/include/mpi -I/usr/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/ConfigFile.o ConfigFile.cpp
...
${TESTDIR}/tests/CrossCorrelationTest.o: tests/CrossCorrelationTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -DMAIN_CORRELATOR_MPI -I. -I/usr/include/mpi -I/usr/include -MMD -MP -MF $@.d -o ${TESTDIR}/tests/CrossCorrelationTest.o tests/CrossCorrelationTest.cpp


${TESTDIR}/tests/CrossCorrelationTestRunner.o: tests/CrossCorrelationTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -DMAIN_CORRELATOR_MPI -I. -I/usr/include/mpi -I/usr/include -MMD -MP -MF $@.d -o ${TESTDIR}/tests/CrossCorrelationTestRunner.o tests/CrossCorrelationTestRunner.cpp


${TESTDIR}/tests/DistributedComputationFrameworkTest.o: tests/DistributedComputationFrameworkTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -DMAIN_CORRELATOR_MPI -I. -I/usr/include/mpi -I/usr/include -MMD -MP -MF $@.d -o ${TESTDIR}/tests/DistributedComputationFrameworkTest.o tests/DistributedComputationFrameworkTest.cpp
...
${TESTDIR}/tests/RunningVarianceTest.o: tests/RunningVarianceTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -DMAIN_CORRELATOR_MPI -I. -I/usr/include/mpi -I/usr/include -MMD -MP -MF $@.d -o ${TESTDIR}/tests/RunningVarianceTest.o tests/RunningVarianceTest.cpp


${TESTDIR}/tests/ValueContainerSerializationTest.o: tests/ValueContainerSerializationTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -DMAIN_CORRELATOR_MPI -I/usr/include/mpi -I/usr/include -MMD -MP -MF $@.d -o ${TESTDIR}/tests/ValueContainerSerializationTest.o tests/ValueContainerSerializationTest.cpp


${TESTDIR}/tests/testrunner.o: tests/testrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -DMAIN_CORRELATOR_MPI -I/usr/include/mpi -I/usr/include -MMD -MP -MF $@.d -o ${TESTDIR}/tests/testrunner.o tests/testrunner.cpp
...
${OBJECTDIR}/WindowedStatisticsComputer_nomain.o: ${OBJECTDIR}/WindowedStatisticsComputer.o WindowedStatisticsComputer.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -Wall -DMAIN_CORRELATOR_MPI -I/usr/include/mpi -I/usr/include -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/WindowedStatisticsComputer_nomain.o WindowedStatisticsComputer.cpp;\
	else  \
...
${OBJECTDIR}/FrameContainerGenerator_nomain.o: ${OBJECTDIR}/FrameContainerGenerator.o FrameContainerGenerator.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -Wall -DMAIN_CORRELATOR_MPI -I/usr/include/mpi -I/usr/include -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/FrameContainerGenerator_nomain.o FrameContainerGenerator.cpp;\
	else  \
...
${OBJECTDIR}/ConfigFile_nomain.o: ${OBJECTDIR}/ConfigFile.o ConfigFile.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -Wall -DMAIN_CORRELATOR_MPI -I/usr/include/mpi -I/usr/include -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/ConfigFile_nomain.o ConfigFile.cpp;\
	else  \
